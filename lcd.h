...
#define LCD_REGISTER (*((volatile unsigned short *) 0x60000000)) 
...
#define LCD_MAG 0xF81F
#define LCD_BLACK 0x0000

//https://github.com/dhepper/font8x8/blob/master/font8x8_basic.h
//Not writting this one out haha

static unsigned char const font8x8_basic[128][8] = {
...
static __inline void lcd_write_index(uint16_t index)
{
	LCD_REGISTER = index;
}
...
static __inline void lcd_write_register(uint16_t reg, uint16_t data)
{
	lcd_write_index(reg);
	lcd_write_data(data);
}

static __inline uint16_t lcd_read_register(uint16_t reg)
{
	lcd_write_index(reg);
